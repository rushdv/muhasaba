...
const RAMADAN_CONTENT: Record<number, DayContent> = {
  1: {
    ...
    hadith:
      "যে ব্যক্তি ঈমানের সাথে ও সওয়াবের আশায় রমজানের রোজা রাখে, তার অতীতের সব গুনাহ মাফ করে দেওয়া হয়। (সহীহ বুখারী: ১৯০১)",
    dua: {
      arabic: "اللَّهُمَّ لَكَ صُمْتُ وَعَلَى رِزْقِكَ أَفْطَرْتُ",
      meaning:
        "হে আল্লাহ! আমি তোমারই জন্য রোজা রেখেছি এবং তোমারই দেয়া রিজিক দ্বারা ইফতার করছি।",
    },
    names: [
      {
        arabic: "الرَّحْمَنُ",
  ...
  2: {
    ...
    hadith:
      "রোজা ঢাল স্বরূপ। সুতরাং রোজা রেখে অশ্লীল কথা বলবে না এবং শোরগোল করবে না। (সহীহ বুখারী: ১৯০৪)",
    dua: {
      arabic:
        "رَبَّنَا آتِنَا فِي الدُّنْيَا حَسَنَةً وَفِي الْآخِرَةِ حَسَنَةً وَقِنَا عَذَابَ النَّارِ",
      meaning:
        "হে আমাদের প্রতিপালক! আমাদের দুনিয়াতে কল্যাণ দিন এবং আখেরাতেও কল্যাণ দিন এবং আমাদের জাহান্নামের আজাব থেকে রক্ষা করুন।",
    },
    names: [
      {
        arabic: "الْقُدُّوسُ",
  ...
  3: {
    ...
    dua: {
      ...
      meaning:
        "হে আল্লাহ! আমি তোমার নিকট উপকারী জ্ঞান, পবিত্র রিজিক এবং কবুলযোগ্য আমল প্রার্থনা করছি।",
    },
    names: [
      {
  ...
  4: {
    ...
    hadith:
      "সবচেয়ে উত্তম মানুষ সে, যে মানুষের উপকার করে। (আল-মু'জামুল আওসাত: ৫৭৮৭)",
    dua: {
      arabic: "يَا مُقَلِّبَ الْقُلُوبِ ثَبِّتْ قَلْبِي عَلَى دِينِكَ",
      meaning:
        "হে অন্তর পরিবর্তনকারী! আমার অন্তরকে তোমার দ্বীনের উপর অবিচল রাখো।",
    },
    names: [
      {
  ...
  7: {
    ...
    hadith:
      "তোমাদের মধ্যে সেই ব্যক্তিই সর্বোত্তম, যে কুরআন শেখে এবং অন্যকে শেখায়। (সহীহ বুখারী: ৫০২৭)",
    dua: {
      arabic:
        "اللَّهُمَّ اعْنِي عَلَى ذِكْرِكَ وَشُكْرِكَ وَحُسْنِ عِبَادَتِكَ",
      meaning:
        "হে আল্লাহ! তোমার যিকির, শোকর ও উত্তম ইবাদত পালনে আমাকে সাহায্য কর।",
    },
    names: [
  ...
  9: {
    ...
    dua: {
      ...
      meaning:
        "হে আমাদের প্রতিপালক! আমাদের স্ত্রীদের ও সন্তানদের আমাদের নয়নপ্রীতিকর করুন।",
    },
    names: [
      {
        arabic: "الْمُذِلُّ",
  ...
  10: {
    ...
    dua: {
      ...
      meaning:
        "হে আল্লাহ! আমি তোমার কাছে হিদায়াত, তাকওয়া, চারিত্রিক পবিত্রতা ও স্বচ্ছলতা প্রার্থনা করছি।",
    },
    names: [
  ...
  11: {
    ...
    dua: {
      ...
      meaning:
        "হে আমাদের প্রতিপালক! আমাদের ধৈর্য দান করুন এবং আমাদের কদম সুদৃঢ় রাখুন।",
    },
    names: [
  ...
  12: {
    ...
    hadith:
      "তোমরা শেষ দশ দিনের বেজোড় রাতে লাইলাতুল কদর তালাশ করো। (সহীহ বুখারী: ২০২১)",
    dua: {
  ...
  13: {
    ...
    hadith:
      "সেই ব্যক্তির উদাহরণ যে তার প্রতিপালককে স্মরণ করে আর যে করে না, তা জীবিত ও মৃতের মতো। (সহীহ বুখারী: ৬৪০৭)",
    dua: {
  ...
  14: {
    ...
    hadith:
      "যাকে শোকর করার তৌফিক দেওয়া হয়েছে, তাকে নেয়ামত বৃদ্ধি থেকে বঞ্চিত করা হবে না। (শুয়াবুল ঈমান)",
    dua: {
  ...
  15: {
    ayat: { surah: 5, ayah: 2 },
    hadith:
      "একজন মুমিন আরেকজন মুমিনের জন্য দেয়ালের ন্যায়, যার এক অংশ অন্য অংশকে শক্তিশালী করে। (সহীহ বুখারী: ৪৮১)",
    dua: {
      arabic: "رَبَّنَا تَقَبَّلْ مِنَّا إِنَّكَ أَنتَ السَّمِيعُ الْعَلِيمُ",
      meaning:
        "হে আমাদের প্রতিপালক! আমাদের পক্ষ থেকে কবুল করুন, নিশ্চয়ই আপনি সর্বশ্রোতা, সর্বজ্ঞ।",
    },
    names: [
      {
        arabic: "الرَّقِيبُ",
  ...
  16: {
    ...
    hadith:
      "আল্লাহ তোমাদের চেহারা ও সম্পদের দিকে তাকান না, বরং তোমাদের অন্তর ও আমলের দিকে তাকান। (সহীহ মুসলিম: ২৫৬৪)",
    dua: {
  ...
  17: {
    ...
    hadith:
      "যদি তোমরা আল্লাহর উপর ঠিকমতো তাওয়াক্কুল করতে, তবে তিনি তোমাদের পাখিদের ন্যায় রিজিক দিতেন। (সুনানে তিরমিজি: ২৩৪৪)",
    dua: {
  ...
  18: {
    ...
    hadith:
      "আল্লাহ ঐ ব্যক্তিকে পছন্দ করেন, যে শ্রমের সাথে তার কাজ নিখুঁতভাবে করে। (আল-জামি আস-সাগীর: ১৮৯২)",
    dua: {
  ...
  19: {
    ...
    hadith:
      "পুরো পৃথিবী আমার জন্য মসজিদ ও পবিত্র বানানো হয়েছে। (সহীহ বুখারী: ৩৩৫)",
    dua: {
  ...
  20: {
    ...
    hadith:
      "কুরআন পাঠ করো, কারণ কিয়ামতের দিন এটি পাঠকারীর জন্য সুপারিশ করবে। (সহীহ মুসলিম: ৮০৪)",
    dua: {
  ...
  21: {
    ...
    hadith:
      "আল্লাহ বলেন: আমি আমার বান্দার সাথে থাকি যখন সে আমাকে স্মরণ করে। (সহীহ বুখারী: ৭৪০৫)",
    dua: {
      arabic: "يَا حَيُّ يَا قَيُّومُ بِرَحْمَتِكَ أَسْتَغِيثُ",
      meaning:
        "হে চিরঞ্জীব! হে চিরবিরাজমান! আমি তোমার রহমতের মাধ্যমে সাহায্য চাচ্ছি।",
    },
    names: [
      {
        arabic: "الْمُمِيتُ",
  ...
  22: {
    ...
    hadith:
      "আমি উত্তম চরিত্র সম্পন্ন করার জন্যই প্রেরিত হয়েছি। (মুয়াত্তা মালিক: ১৬৩১)",
    dua: {
  ...
  25: {
    ...
    hadith:
      "সেই ব্যক্তিই প্রকৃত মুজাহিদ, যে তার নফসের বিরুদ্ধে জিহাদ করে। (সুনানে তিরমিজি: ১৬২১)",
    dua: {
  ...
  26: {
    ...
    hadith:
      "যে ব্যক্তি লাইলাতুল কদরের রাতে ঈমানের সাথে ইবাদত করবে, তার অতীতের সব গুনাহ মাফ হবে। (সহীহ বুখারী: ১৯০১)",
    dua: {
      arabic:
        "اللَّهُمَّ إِنِّكَ عَفُوٌّ كَرِيمٌ تُحِبُّ الْعَفْوَ فَاعْفُ عَنِّي",
      meaning:
        "হে আল্লাহ! আপনি ক্ষমাশীল, আপনি ক্ষমা করতে ভালোবাসেন, অতএব আমাকে ক্ষমা করুন।",
    },
    names: [
  ...
  27: {
    ...
    dua: {
      ...
      meaning:
        "হে আল্লাহ! যেদিন তুমি তোমার বান্দাদের পুনরুত্থিত করবে, সেদিন আমাকে তোমার আজাব থেকে রক্ষা করো।",
    },
    names: [
      {
        arabic: "التَّوَّابُ",
  ...
  28: {
    ...
    hadith:
      "মৃত্যুর পর তিনটি আমল ছাড়া সবকিছু বন্ধ হয়ে যায়: সদকায়ে জারিয়া, উপকারী জ্ঞান এবং নেক সন্তান। (সহীহ মুসলিম: ১৬৩১)",
    dua: {
  ...
  29: {
    ...
    hadith:
      "রমজানের শেষে মুক্তিপ্রাপ্তদের তালিকায় তোমার নাম লিখে দেওয়া হোক। (বায়হাকী)",
    dua: {
